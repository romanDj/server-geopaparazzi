...
from geopaparazzi import qgis_server, geoserver
from geopaparazzi.api.paginator import CrossSiteXHRPaginator
from geopaparazzi.api.authorization import geopaparazziStyleAuthorization
from geopaparazzi.qgis_server.models import QGISServerStyle
from guardian.shortcuts import get_objects_for_user
from tastypie.bundle import Bundle

from geopaparazzi.base.models import ResourceBase
from geopaparazzi.base.models import TopicCategory
from geopaparazzi.base.models import Region
from geopaparazzi.base.models import HierarchicalKeyword
from geopaparazzi.base.models import ThesaurusKeywordLabel
from geopaparazzi.layers.models import Layer, Style
from geopaparazzi.maps.models import Map
from geopaparazzi.documents.models import Document
from geopaparazzi.groups.models import GroupProfile, GroupCategory
...
from geopaparazzi.utils import check_ogc_backend
from geopaparazzi.security.utils import get_visible_resources
...
class GroupProfileResource(ModelResource):
    ...
    def dehydrate_member_count(self, bundle):
        """Provide relative URL to the geopaparazzi UI's page on the group"""
    ...
    def dehydrate_detail_url(self, bundle):
        """Return relative URL to the geopaparazzi UI's page on the group"""
...
class QGISStyleResource(ModelResource):
    ...
    layer = fields.ForeignKey(
        'geopaparazzi.api.resourcebase_api.LayerResource',
        attribute='layer',
        null=True)
    ...
    class Meta:
        ...
        authorization = geopaparazziStyleAuthorization()
        filtering = {
            'id': ALL,
            'title': ALL,
            'name': ALL,
    ...
    def populate_object(self, style):
        ...
        try:
            ...
            """:type: geopaparazzi.qgis_server.QGISServerLayer"""
    ...
    def post_list(self, request, **kwargs):
        ...
        """
        from geopaparazzi.qgis_server.views import qml_style
